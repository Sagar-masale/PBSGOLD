        ...
        <div className="End-info">
          <div className="fit-info-box">
            <div className="info-box info-box1">
              <h6 className="information-link-head link-Head-Width">Useful Links</h6>
              ...
              <div className="Show-First-Box info-box info-box1 " id="Clicked-One">
                <a href="#Track Your Order" className="Track-Your-Order Go-info-link Go-info-link-On-Click-One">Track Your Order</a>
                <a href="#Return" className="Track-Your-Order Go-info-link Go-info-link-On-Click-One">Return</a>
                <a href="#Shipments" className="Go-info-link Go-info-link-On-Click-One">Shipments</a>
                <a href="#Encircle Program" className="Go-info-link Go-info-link-On-Click-One">Encircle Program</a>
                <a href="#Find a Store" className="Go-info-link Go-info-link-On-Click-One">Find a Store</a>
              </div>
            </div>
            <div className="info-box info-box2">
              <h6 className="information-link-head link-Head-Width">Information</h6>
              ...
              <div className="Show-Second-Box info-box info-box1" id="Clicked-Two">
                <a href="#Diamond Guide" className="Track-Your-Order Go-info-link Go-info-link-On-Click-Two">Diamond Guide</a>
                <a href="#Blog" className="Go-info-link Go-info-link-On-Click-Two">Blog</a>
                <a href="#Gemstone Guide" className="Go-info-link Go-info-link-On-Click-Two">Gemstone Guide</a>
                <a href="#Metal Guide" className="Go-info-link Go-info-link-On-Click-Two">Metal Guide</a>
                <a href="#About PBS" className="Go-info-link Go-info-link-On-Click-Two">About PBS</a>
              </div>
            </div>
